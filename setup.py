...
def banner():
	...
	{re}╚═╝{cy}└─┘ ┴ └─┘┴
	           ...
	           Version : 1.01
	{re}Subscribe hackermachan on Youtube
	{cy}https://www.youtube.com/channel/UC5AmiT44HyEZ2Rkc0WT0ZZA
	""")
banner()
...
print(gr+"[+] https://github.com/hackermachan/TeleGram-Scraper-Adder/blob/master/README.md")
